...
<div class="row">
<?php 
$sql = "SELECT products.title,type.typename,type.id,products.price,products.id,products.description,products.Vimage1 from products join type on type.id=products.ptype limit 8";
...
<div class="col-md-6 text-md-right">
	<a href="coming.php"><img src="images/misc/appstore.png" height="40"></a>
	<a href="coming.php"><img src="images/misc/appstore.png" height="40"></a>
</div>
</div> <!-- row.// -->
</div><!-- container // -->
