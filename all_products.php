...
<article class="card card-product-list">
	<div class="row no-gutters">
		<aside class="col-md-3">
			<a href="products/product_details.php?vhid=<?php echo htmlentities($result->id);?>" class="img-wrap">
		...
		<div class="col-md-6">
			<div class="info-main">
				<a href="products/product_details.php?vhid=<?php echo htmlentities($result->id);?>" class="h5 title"><?php echo htmlentities($result->title);?></a>
