...
<title>Zirconium - Babies & Toys</title>
...
<div class="container">
	<h2 class="title-page">Babies & Toys</h2>
	<nav>
	<ol class="breadcrumb text-white">
	    <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
	    <li class="breadcrumb-item active" aria-current="page">Babies & Toys</li>
	</ol>  
	</nav>
</div> <!-- container //  -->
</section>
...
<div class="card">
	...
	<article class="filter-group">
		...
		<?php
		$sql ="SELECT id,brand from products WHERE ptype='9' ";
...
<?php
$sql ="SELECT id from products WHERE ptype='9' ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
<?php $sql = "SELECT products.oprice,products.title,type.typename,type.id,products.price,products.id,products.description,products.Vimage1 from products join type on type.id=products.ptype WHERE type.id='9'";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
