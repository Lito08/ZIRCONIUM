...
$gender=$_POST['gender'];
$id=$_GET['id'];
$sql="update  users set user_name=:username, email=:email, full_name=:fullname, country=:country, city=:city, gender=:gender where id=:id";
...
<head>
	...
	<title>Edit Registration Users | Super Admin Edit users</title>
										...
										<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<a href="../superadmin/reg-users.php">Back</a>
													</form>
												</div>
											</div>
