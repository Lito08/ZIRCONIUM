...
<title>Zirconium - Automotive & Motorcycles</title>
...
<div class="container">
	<h2 class="title-page">Automotive & Motorcycles</h2>
	<nav>
	<ol class="breadcrumb text-white">
	    <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
	    <li class="breadcrumb-item active" aria-current="page">Automotive & Motorcycles</li>
	</ol>  
	</nav>
</div> <!-- container //  -->
</section>
...
<div class="card">
	...
	<article class="filter-group">
		...
		<?php
		$sql ="SELECT id,brand from products WHERE ptype='12' ";
	...
	<?php
$sql ="SELECT id from products WHERE ptype='12' ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
