...
<div class="card">
	...
	<article class="filter-group">
		...
		<?php
		$sql ="SELECT id,brand from products WHERE ptype='2' ";
...
<?php
$sql = "SELECT products.oprice,products.ribbon,products.title,type.typename,type.id,products.price,products.id,products.description,products.Vimage1 from products join type on type.id=products.ptype WHERE type.id='2'";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
	...
	<div class="row no-gutters">
		<aside class="col-md-3">
			<a href="product_details.php?vhid=<?php echo htmlentities($result->id);?>" class="img-wrap">
				<span class="badge badge-danger"><?php echo htmlentities($result->ribbon);?> </span>
